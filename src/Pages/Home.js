...
import aron from "../Assets/jeemonpic.png";
    ...
    >
      <div className="container mx-auto font-serif grid grid-cols-1 md:grid-cols-2 ">
        <div className="flex flex-col md:justify-center lg:justify-center lg:items-start pl-2 ">
          ...
          <h1 className="text-black font-extrabold pl-2 lg:text-[70px] sm:text-4xl text-4xl md:text-4xl font-sans">
  Jeemon George
</h1>
            <div className="md:flex ">
              ...
              {/* ------------------------------------- */}
              <a href="https://github.com/JeemonGeorge">
                <button
                  type="button"
